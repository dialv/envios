...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        final AppUserDetailsModel user = (AppUserDetailsModel) auth.getPrincipal();
    ...
    private String createToken(AppUserDetailsModel userDetails, long accessTokenValiditySeconds) {
    ...
    private void writeSessionData(HttpServletResponse response, AppUserDetailsModel userDetails, String token, long expiration) throws IOException {
